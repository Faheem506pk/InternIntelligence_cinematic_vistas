...
>
    ...
    <div className=" px-6 md:px-12">
      <div className="flex items-center justify-between h-16 md:h-20">
        ...
        >
          <span className={`pr-1 ${location.pathname === "/" && !isScrolled ? "text-white" : ""}`}>CINEMATIC</span>
          <span className={` ${location.pathname === "/" && !isScrolled ? "text-white/50" : "text-muted-foreground"}`}>VISTAS</span>
        </Link>

...
const Hero = ({ movie }: HeroProps) => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-69px)] w-full overflow-hidden">
  ...
  {/* Content */}
  <div className="absolute inset-0 flex items-center justify-start pt-[69px]">
    <div className="container mx-auto px-4 pb-10 md:pb-0 animate-fade-in">
      <div className="max-w-2xl space-y-4">
        ...
        <h1 
          className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white drop-shadow-sm animate-fade-in" 
          style={{ animationDelay: "0.4s" }}
        >
          {movie.title}
        </h1>
        <p 
          className="text-white/90 text-sm sm:text-base max-w-xl animate-fade-in" 
